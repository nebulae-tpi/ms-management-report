...
![Intro](docs/images/ms-management-report_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [management-report](#backend_management-report)
        * [Environment variables](#backend_management-report_env_vars)
        * [Event Sourcing](#backend_management-report_eventsourcing)
        * [CronJobs](#backend_management-report_cronjobs)
...
│   ├── management-report                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/management-report/schema.gql)
...
### GraphQL Queries
#### getHelloWorldFrommanagement-report
...
#### management-reportHelloWorldSubscription
...
## management-report <a name="backend_management-report"></a>
...


### Environment variables <a name="backend_management-report_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/management-report/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-management-report.yaml)

### Event Sourcing <a name="backend_management-report_eventsourcing"></a>
...
### CronJobs <a name="backend_management-report_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-tpi/ms-management-report.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-tpi/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-management-report/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-management-report/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpi/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-management-report/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-management-report/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-management-report/backend/management-report/.env   *WORKING_FOLDER*/ms-management-report/playground/emi-gateway/.env  
